...
export function CountdownDialog() {
  return (
    <div className="aspect-16/10 h-[80dvh] flex bg-background p-4">
      ...
      <Card className="basis-1/4 h-full p-0 gap-0 border-0 overflow-hidden">
      ...
      <Card className="basis-3/4 rounded-l-none p-0 gap-0 border-0 bg-transparent overflow-hidden">
        <RightPanel />
      </Card>
    </div>
  )
